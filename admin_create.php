...
<head>
    ...
    <title>eSumbong Create Admin Account</title>
...
<body>
    <header class="header-1">
        <div class="headerlogo">
            <p class="hello"> HELLO OVERLORD!</p>
        </div>
        <nav class="navbar">
            ...
            <div class="navbar-buttons" id="navbar-buttons">
                <a href="admin-accounts-table.php"><button>Go back</button></a>
            </div>
        </nav>
    </header>  
    ...
    <div class="container">
        <?php if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $admin_email = $_POST["recipient_email"];
            $admin_password = $_POST["typepassword"];

            $hashed_password = password_hash($admin_password, PASSWORD_DEFAULT);

            $sql = "INSERT INTO admin_acc (firstname, lastname, username, admin_email, admin_password)
            VALUES ('$firstname', '$lastname', '$username', '$admin_email', '$hashed_password')";
